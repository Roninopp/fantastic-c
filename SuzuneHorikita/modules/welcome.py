...
import SuzuneHorikita.modules.sql.welcome_sql as sql
...
from SuzuneHorikita.modules.helper_funcs.misc import build_keyboard, revert_buttons
from SuzuneHorikita.modules.helper_funcs.msg_types import get_welcome_type
from SuzuneHorikita.modules.helper_funcs.handlers import MessageHandlerChecker
from SuzuneHorikita.modules.helper_funcs.string_handling import (
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_photo(photo="https://telegra.ph/file/03595f5dfede930679e98.jpg", 
                    caption="Welcome to {html.escape(chat.title)} my king.", reply_to_message_id=reply
                )
                welcome_log = (
