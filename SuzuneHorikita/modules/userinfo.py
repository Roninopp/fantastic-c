...
from SuzuneHorikita.modules.sql.afk_sql import is_afk, set_afk
...
def stats(update: Update, context: CallbackContext):
    ...
    update.effective_message.reply_text(photo="https://telegra.ph/file/00ba6fc88be9c1bfa178c.jpg", caption=
        result,
        parse_mode=ParseMode.HTML, 
        disable_web_page_preview=True
   )
