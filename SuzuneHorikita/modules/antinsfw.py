...
from SuzuneHorikita import DRAGONS, BOT_USERNAME, arq, pgram

from SuzuneHorikita.utils.errors import capture_err

from SuzuneHorikita.utils.permissions import adminsOnly

from SuzuneHorikita.modules.mongo.nsfw_mongo import is_nsfw_on, nsfw_off, nsfw_on
...
async def nsfw_enable_disable(_, message):
    ...
    if status in ("on", "yes"):
        ...
        await message.reply("Enabled AntiNSFW System. I will Delete Messages Containing Inappropriate Content.")
