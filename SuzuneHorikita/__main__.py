...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            SuzuneHorikitarobot_IMG, caption= "<a href="https://telegra.ph/file/18104996516b310ecd376.jpg">Yo! Me Alive</a>".format(
                uptime
            ),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}",f"[Yo! Me Alive](https://telegra.ph/file/18104996516b310ecd376.jpg)")
        except Unauthorized:
            LOGGER.warning(
